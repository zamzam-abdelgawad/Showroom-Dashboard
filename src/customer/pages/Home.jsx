  ...
  return (
    <div className="animate-in">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
        {/* Search & Filter */}
        <div className="flex flex-col sm:flex-row gap-4 items-center justify-between bg-white rounded-2xl border border-gray-200/60 shadow-sm p-4 -mt-8 relative z-5">
          ...
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              ...
              <select
                className="h-10 rounded-xl border border-gray-200 bg-white px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-shadow"
                value={statusFilter}
        ...
        {loading ? (
          ...
          <StaggeredGrid className="grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredCars.map((car) => (
              <StaggeredCard
                key={car.id}
                className="p-0 border-none shadow-md hover:shadow-xl transition-all duration-500 cursor-pointer group overflow-hidden rounded-2xl"
              ...
              >
                <div className="relative aspect-[16/10] bg-gray-100 overflow-hidden">
                  ...
                  <div className="absolute bottom-3 right-3">
                    <span className="bg-white/90 backdrop-blur-sm text-gray-900 font-extrabold text-sm px-3 py-1.5 rounded-xl shadow-lg">
                ...
                <CardContent className="p-5">
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      ...
                      <h3 className="text-lg font-bold text-gray-900 group-hover:text-indigo-600 transition-colors duration-300">{car.name}</h3>
                    </div>
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-gray-100">
                    ...
                    <span className="text-xs font-bold text-indigo-600 flex items-center gap-1 group-hover:translate-x-1 transition-transform duration-300">

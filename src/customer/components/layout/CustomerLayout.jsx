          ...
          <header className="bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl border-b border-zinc-100 dark:border-zinc-800/80 h-16 sm:h-20 flex items-center justify-between px-4 sm:px-6 lg:px-12 sticky top-0 z-50 w-full shadow-[0_1px_2px_rgba(0,0,0,0.02)]">
            <div className="flex items-center gap-4 sm:gap-10 min-w-0">
              <Link to="/" className="flex items-center gap-2 sm:gap-3.5 group flex-shrink-0">
                ...
                <h2 className="text-base sm:text-xl font-black text-zinc-900 dark:text-zinc-50 tracking-tighter uppercase whitespace-nowrap">
            ...
            <div className="flex items-center gap-2 sm:gap-3 lg:gap-6 flex-shrink-0">
              ...
              {user ? (
                <div className="flex items-center gap-2">
                  <Link to="/profile" className="flex items-center gap-1.5 sm:gap-2.5 text-[10px] font-black uppercase tracking-widest text-zinc-900 dark:text-zinc-100 bg-zinc-50/50 dark:bg-zinc-900/50 hover:bg-zinc-100 dark:hover:bg-zinc-800 px-2 sm:px-4 py-1.5 sm:py-2 rounded-xl transition-all border border-zinc-100 dark:border-zinc-800 shadow-sm">
                ...
                <div className="flex items-center gap-2 sm:gap-3">
                  <Link to="/login" className="hidden sm:block">
                    <Button variant="ghost" size="sm" className="text-[10px] font-black uppercase tracking-widest rounded-xl h-10 px-4 lg:px-6">Sign In</Button>
                  </Link>
                  <Link to="/register">
                    <Button size="sm" className="text-[10px] font-black uppercase tracking-[0.2em] rounded-xl h-9 sm:h-10 px-4 sm:px-8 bg-brand-primary hover:bg-brand-primary/90 shadow-xl shadow-brand-primary/20 transition-all active:scale-95">Sign Up</Button>
                  </Link>
                </div>
              )}
            </div>
          ...
          <footer className="bg-white dark:bg-zinc-950 border-t border-zinc-100 dark:border-zinc-900 py-12 sm:py-16 px-4 sm:px-6 lg:px-12 transition-colors w-full overflow-x-hidden">
            <div className="max-w-7xl mx-auto">
              <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-12 mb-12 sm:mb-16">
                <div className="sm:col-span-2 space-y-4 sm:space-y-6">
                  <div className="flex items-center gap-2 sm:gap-3">
                    ...
                    <span className="text-lg sm:text-xl font-black text-zinc-950 dark:text-zinc-50 uppercase tracking-tighter">Showroom<span className="text-brand-primary">Elite</span></span>
                  </div>
                ...
                <div>
                  <h4 className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.3em] mb-4 sm:mb-6">Quick Links</h4>
                ...
                <div>
                  <h4 className="text-[10px] font-black text-zinc-400 uppercase tracking-[0.3em] mb-4 sm:mb-6">Channels</h4>
                  <div className="space-y-3 sm:space-y-4">
                    <p className="text-[11px] font-black uppercase tracking-widest text-zinc-500 break-all">Comms: info@showcase.com</p>
              ...
              <div className="pt-8 sm:pt-10 border-t border-zinc-50 dark:border-zinc-900 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-6">
                <div className="text-[9px] font-black text-zinc-400 uppercase tracking-[0.3em] text-center sm:text-left">
                  © 2026 ShowroomElite.
                </div>

  ...
  return (
    <header className="bg-white border-b border-gray-200 h-16 flex items-center justify-between px-4 sm:px-6 sticky top-0 z-10 w-full shadow-sm">
      ...
      <div className="flex items-center gap-2 sm:gap-5">
        <Link to="/admin/profile" className="flex items-center gap-2 text-sm font-semibold text-gray-700 bg-gray-50 hover:bg-gray-100 px-2 sm:px-3 py-1.5 rounded-full transition-colors border border-gray-100">

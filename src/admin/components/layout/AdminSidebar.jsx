  ...
  return (
    <aside className={cn(
      ...
      <div className="p-4 flex-1 space-y-1 overflow-y-auto">
        <p className="px-3 text-[10px] font-bold text-zinc-500 uppercase tracking-[0.2em] mb-4 mt-2">Navigation</p>
        {links.map((link) => (
          <NavLink
            key={link.path}
            to={link.path}
          ...
          >
            ...
            {link.badge > 0 && (
              <span className="bg-brand-secondary text-brand-dark text-[10px] font-bold px-1.5 py-0.5 rounded-full min-w-[20px] text-center leading-none">
      ...
      <div className="p-4 border-t border-zinc-900 flex-shrink-0">
        <div className="bg-zinc-900/50 rounded-xl p-4 border border-zinc-800/50">
          <p className="text-[10px] font-bold text-zinc-500 mb-1.5 uppercase tracking-wider text-center">System Identity</p>

    ...
    <div className="w-full relative group">
      <input
        ...
        className={cn(
          ...
          error && "border-red-500 focus:ring-red-500 dark:border-red-400 dark:focus:ring-red-400 font-bold",
          rightElement && "pr-10",
          className
        )}
        ref={ref}
      ...
      {error && <p className="mt-1 text-[10px] font-black uppercase tracking-widest text-red-500">{error}</p>}
    </div>
  );
});
